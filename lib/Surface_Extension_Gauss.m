...
m_ext = floor(brf_params.lat_res_brf*(size(Z_tif, 1))*0.5/surf_mpp);   ... extension size in y [pixel]
n_ext = floor(brf_params.lat_res_brf*(size(Z_tif, 2))*0.5/surf_mpp);   ... extension size in x [pixel] 
