...
% x_edge=[X_ext(1, 1);X_ext(1,end)';X_ext(end,1);X_ext(end,end)']; 
% y_edge=[Y_ext(1, 1);Y_ext(1,end)';Y_ext(end, 1);Y_ext(end,end)'];
% z_edge = 0*x_edge;
% p = 8;
% x_edge=[X_ext(1:p:end, 1);X_ext(1,1:p:end)';X_ext(1:p:end,end);X_ext(end,1:p:end)']; 
% y_edge=[Y_ext(1:p:end, 1);Y_ext(1,1:p:end)';Y_ext(1:p:end,end);Y_ext(end,1:p:end)'];
% z_edge = 0*x_edge;
